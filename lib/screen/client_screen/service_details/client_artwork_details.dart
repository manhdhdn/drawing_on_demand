...
class ClientArtworkDetails extends StatefulWidget {
  static const String tag = '${ClientHomeScreen.tag}/arworkDetails';

  const ClientArtworkDetails({Key? key}) : super(key: key);

  @override
  State<ClientArtworkDetails> createState() => _ClientArtworkDetailsState();
}

class _ClientArtworkDetailsState extends State<ClientArtworkDetails>
    with TickerProviderStateMixin {
  late Future<Artwork?> artworkDetails;
                              ...
                              HorizontalList(
                                ...
                                itemBuilder: (_, i) {
                                  return Padding(
                                    ...
                                    child: GestureDetector(
                                      onTap: () => const ClientArtworkDetails()
                                          .launch(context),
                                      child: Container(
                                        height: 120,
                                        decoration: BoxDecoration(
  ...
  Future<Artwork?> getData() async {
    try {
      return ArtworkApi().getOne(
        PrefUtils().getTermId(),
        'createdByNavigation, arts, artworkReviews',
      );
    } catch (error) {
      Fluttertoast.showToast(msg: 'Get artworks details failed');
    }
